...
return array(
	...
	'BaseURI'					=> 'smokecp',						// The base URI is the base web root on which your application lies.
	...
	'SiteTitle'					=> 'Painel de Controle - SmokeWorld',	// This value is only used if the theme decides to use it.
	'ThemeName'					=> array('smoke', 'default', 'bootstrap'), // Names of the themes you would like list for use in the footer. Themes are in FLUX_ROOT/themes.
	...
	'ItemIconNameFormat'		=> '%d.bmp',				// The filename format for item icons (defaults to {itemid}.png).
	'ItemImageNameFormat'		=> '%d.bmp',				// The filename format for item images (defaults to {itemid}.png).
	'MonsterImageNameFormat'	=> '%d.png',				// The filename format for monster images (defaults to {monsterid}.gif).
	'JobImageNameFormat'		=> '%d.png',				// The filename format for job images (defaults to {jobid}.gif).
	...
	'PayPalBusinessEmail'		=> 'maran.dogpunk@gmail.com',		// Enter the e-mail under which you have registered your business account.
...
// Discord Webhooks
	...
	'MenuItems'		=> array(
		...
		'SocialLabel'		=> array(
			'JoinUsInFacebookLabel'	=> array('exturl' => 'https://discord.gg/bpyrwt4DFn'),
